...
// const pizzaTwoId = document.getElementById("pizza2");
...
<div class="bg-padding card-home"></div>
<!-- Background Images -->
<div class="pizza-box">
<img id="pizzaWeb" class="pizza-bg" src="images/Home.png" alt="">
<img class="pizza-bg pizzaMobile" src="images/pizzaMobileHomePage.png" alt="">

<!-- Customize -->
    <div class="order-txt"><h4 class="border-btm-line pizza-font">Customize Your Own Pizza! </h4><li>Start From Scratch!</li><li>First Topping is <b>FREE!</b></li><li>5+ Toppings === <b>SPECIAL DEAL!</b>  </li></div>
  <button type="button" class="order-btn btn btn-custom" data-toggle="modal" data-target="#exampleModalCenter" data-backdrop="static" data-keyboard="false">
    <b>CUSTOMIZE</b>
  </button>
</div>
...
<!-- Pre Built Pizzas -->
<div class="bg-padding card-home"></div>
<div class="pizza-box bg-raisin-black white-txt  card-home"><h3 class="pizza-font">Pre-Built Pizzas</h3></div>
          ...
          <div class="row">
            <div class="col-5">
              ...
              <div class="direction-column">
                ...
                <p></p>
                <h6 id="orderSize">10" Small Pizza</h6>
                <p></p>
                <p><b>Toppings:</b></p>
                <div class="row">
